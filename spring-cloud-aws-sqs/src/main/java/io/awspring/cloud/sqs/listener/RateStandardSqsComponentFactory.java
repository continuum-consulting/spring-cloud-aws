...
import io.awspring.cloud.sqs.listener.source.RateStandardSqsMessageSource;
 ...
 */
public class RateStandardSqsComponentFactory<T> implements ContainerComponentFactory<T, SqsContainerOptions> {
	...
	public MessageSource<T> createMessageSource(SqsContainerOptions options) {
		return new RateStandardSqsMessageSource<>();
	}
